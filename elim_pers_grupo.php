...
$SUsuariosNoEnGrupo = "SELECT p.idUsuari
                        FROM PERTANYER p
                        WHERE p.idGrup = '$grupoSeleccionado'";
...
<body>
  ...
  <h1>Eliminar Usuaris al Grup: <?php echo htmlspecialchars($nombreGrupo); ?></h1>
  ...
  <div class="form-container">
      ...
      if (!empty($usuariosNoEnGrupo)) {
          foreach ($usuariosNoEnGrupo as $usuario) {
            echo '<form action="php/process_elim_pers_grupo.php" method="POST">';
